...
#' @import janitor
#'
#' @examples t4.4 <- create_t4.4_5_6(bth_data, year = 2022, col_var = fert_age_grp, by_var = multbth, rural_urban = "no", tablename = "Table_4_4")
...
create_t4.4_5_6 <- function(data, year = 2022, col_var = fert_age_grp, by_var = multbth, rural_urban = "no", tablename = NA) {
  if(rural_urban == "no"){
  output <- data |>
